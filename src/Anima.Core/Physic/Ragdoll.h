...
public:
	...
	*/
	...
	public:
		...
		RagBone( RagDoll* creator, OgreNewt::World* world, RagBone* parent, Ogre::Bone* ogreBone, Ogre::Mesh *mesh, Ogre::Vector3 dir, RagBone::BoneShape shape, Ogre::Vector3 size, Ogre::Real mass );
	...
	// constructor
	RagDoll( OgreNewt::World* world,GfxModel *model);
...
private:
	...
	void _addAllBones( RagBone* parent, QDomElement& bone );
