...
private:
	...
	const TCHAR *	ClassName() { return "AnimaObjectSubMesh"; }
	SClass_ID		SuperClassID() { return GEOMOBJECT_CLASS_ID; }
	Class_ID		ClassID() { return MeshObjectSubMesh_CLASS_ID; }
	const TCHAR* 	Category() { return "AnimaCategory"; }
	virtual BOOL	NeedsToSave() { return FALSE; }

	const TCHAR*	InternalName()				{ return _T("AnimaObjectSubMesh"); }
	HINSTANCE		HInstance()	;
};
...
public:			
		...
		TCHAR *GetObjectName() { return ("an(i)maMeshRoot");}
		BOOL HasUVW();
		...
		SClass_ID SuperClassID() { return GEOMOBJECT_CLASS_ID; }
		Class_ID ClassID() { return MeshObject_CLASS_ID; } 
		void GetClassName(TSTR& s) {s = "AnimaObject";}
...
public:			
	...
	//	INode *GetNode(){return node;}
		...
		SClass_ID SuperClassID() { return GEOMOBJECT_CLASS_ID; }
		Class_ID ClassID() { return MeshObjectSubMesh_CLASS_ID; } 
		void GetClassName(TSTR& s) {s = "MeshObjectSubMesh";}
