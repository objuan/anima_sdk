...
LIST_MAX_DLL   = $(OBJ_DIR)\SubMeshObj.obj $(OBJ_DIR)\MaterialManager.obj $(OBJ_DIR)\MAXAnima.obj \
				$(OBJ_DIR)\MAXApi.obj $(OBJ_DIR)\MeshObj.obj $(OBJ_DIR)\MeshObjUI.obj 
...
DEFINES = /D $(MAX_DEFINES)  /D $(MAX_DEFINES) /D OGRE_VERSION_17 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_CRT_SECURE_NO_DEPRECATE" \
...
CFLAGS   = $(INCLUDES) $(DEFINES) $(DEFINES_UNICODE) $(OPTIMIZE) /GF /FD /Fd"$(OBJ_DIR)\vc90.pdb" /EHa /MD /GS- /Gy /arch:SSE /fp:fast \
			/Fo"$(OBJ_DIR)/"  \
...
$(TARGET_NAME).dll : $(LIST_MAX_DLL)
    rc /d "_VC80_UPGRADE=0x0710" /fo"$(OBJ_DIR)\resource.res" $(WRK_DIR)\resource.rc"
